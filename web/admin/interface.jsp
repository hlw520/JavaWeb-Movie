    ...
    <script>
        $(function () {
            ...
            $.get('findJxdataServlet',function (data) {
                for(var key in data){
                    $("#jx_"+ data[key].id).attr('value',data[key].jx_value);
                }
            })
            $('#btn1').click(function () {
                $.get('updateJxdataServlet', function () {
                    alert("修改成功");
                })
            })
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">接口设置</a>
                </div>
            </div>
        </nav>
...
<!-- --------------------------------------分割线---------------------------------- -->
<div class="content">
            <form  class="form-horizontal" role="form" action="updateJxdataServlet" method="post">
			  <div class="form-group">
			    <label class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;接口1：</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="jx_1" placeholder="请输入接口" value="" name="jx_1">
			    </div>
				
			  </div>
			  
			  <div class="form-group">
			    <label  class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;接口2：</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="jx_2" placeholder="请输入接口" value="" name="jx_2">
			    </div>
			  </div>
			  <div class="form-group">
			    <label  class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;接口3：</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="jx_3" placeholder="请输入接口" value="" name="jx_3">
			    </div>
			  </div>
			  <div class="form-group">
			    <label  class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;接口4：</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="jx_4" placeholder="请输入接口" value="" name="jx_4">
			    </div>
			  </div>
			  <div class="form-group">
			    <label  class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;接口5：</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="jx_5" placeholder="请输入接口" value="" name="jx_5">
			    </div>
			  </div>
