    ...
    <script>
        $(function () {
            ...
            $.get('findTitleServlet',function (data) {
                for(var key in data){
                    //导航名
                    $("#title_"+ data[key].id).attr('value',data[key].title_name);
                    //导航跳转网址
                    $("#url_"+ data[key].id).attr("value",data[key].title_url);
                    // alert(data[key].title_name);

                }
            })
            $('#btn1').click(function () {
                $.get('updateTitleServlet', function () {
                    alert("修改成功");
                })
            })
            ...
            //     var u3 = $('#url_3').val();
            //     var u4 = $('#url_4').val();
            //     $.get('updateTitleServlet',{'t1':t1,'t2':t2,'t3':t3,'t4':t4,'u1':u1,'u2':u2,'u3':u3,'u4':u4},function (data) {
            //     })
            // })
        })
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">导航设置</a>
                </div>
            </div>
        </nav>
...
<!-- --------------------------------------分割线---------------------------------- -->
        ...
        <div class="content">
			<form  class="form-horizontal" role="form" action="updateTitleServlet" method="post">
			  
			  <div class="form-group">
			    <label class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;标题1：</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="title_1" placeholder="请输入标题内容" value="" name="title_1">
			    </div>
			  </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="url_1" placeholder="请加上http://" value="" name="url_1">
                    </div>
                </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="title_2" placeholder="请输入标题内容" value="" name="title_2">
			    </div>
			  </div>
                <div class="form-group">
                    <label class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;网址：</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="url_2" placeholder="请加上http://" value="" name="url_2">
                    </div>
                </div>
			  <div class="form-group">
			    <label  class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;标题3：</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="title_3" placeholder="请输入标题内容" value="" name="title_3">
			    </div>
			  </div>
                <div class="form-group">
                    <label class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;网址：</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="url_3" placeholder="请加上http://" value="" name="url_3">
                    </div>
                </div>
			  <div class="form-group">
			    <label  class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;标题4：</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="title_4" placeholder="请输入标题内容" value="" name="title_4">
			    </div>
			  </div>
                <div class="form-group">
                    <label class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;网址：</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="url_4" placeholder="请加上http://" value="" name="url_4">
                    </div>
                </div>

			  
			 <div class="col-sm-offset-2 col-sm-8"><input id="btn1" type="submit" name="submit" value="提交" class="btn btn-success form-control" style="background-color: #5cb85c;color: #fff;font-size: 16px"><br>
			   </div>
