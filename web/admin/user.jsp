...
<head>
    ...
    <script>
        $(function () {
            ...
            $('#btn1').click(function () {
                $.get('updateUsersServlet', function () {
                    alert("修改成功");
                })
            })
...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">管理员设置</a>
                </div>
            </div>
        </nav>
        ...
        <div class="content">
            <form  class="form-horizontal" role="form" action="updateUsersSevlet" method="post">

                <div class="form-group">
                    <label  class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;管理员姓名：</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="name" placeholder="请输入管理员姓名" value="" name="name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="user" placeholder="请输入管理员账户" value="" name="user">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="password" class="form-control" id="pass" placeholder="请输入管理员密码" value="" name="pass">
                    </div>
                </div>
                <div class="form-group">
                    <label  class="col-sm-2  control-label" >&nbsp;&nbsp;&nbsp;&nbsp;管理员QQ：</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="qq" placeholder="请输入管理员QQ" value="" name="qq">
                    </div>
                </div>
